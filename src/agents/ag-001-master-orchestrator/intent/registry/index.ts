...
export function buildDefaultDefinitions(): readonly IntentDefinition[] {
  return [
    ...
    {
      id: IntentId.MARKETING_RESEARCH,
      name: 'Marketing Research',
      description:
        'Compile sourced insight summaries for marketing decisions; uncited insights are rejected.',
      category: IntentCategory.Marketing,
      priority: IntentPriority.Low,
      allowedRoles: [UserRole.Client, UserRole.Freelancer],
      confidenceThreshold: 0.55,
      supportedAgents: ['AG-401'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.MARKETING_SOCIAL,
      name: 'Social Media Content',
      description: 'Draft on-brand social posts with platform character budgets; publish is gated.',
      category: IntentCategory.Marketing,
      priority: IntentPriority.Low,
      allowedRoles: [UserRole.Client, UserRole.Freelancer],
      confidenceThreshold: 0.55,
      supportedAgents: ['AG-402'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.MARKETING_BLOG,
      name: 'Blog Content',
      description: 'Draft SEO-ready blog structure from a topic; publish is gated.',
      category: IntentCategory.Marketing,
      priority: IntentPriority.Low,
      allowedRoles: [UserRole.Client, UserRole.Freelancer],
      confidenceThreshold: 0.55,
      supportedAgents: ['AG-403'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.MARKETING_SEO,
      name: 'SEO Recommendations',
      description: 'Recommend on-page SEO improvements; ranking is never guaranteed.',
      category: IntentCategory.Marketing,
      priority: IntentPriority.Low,
      allowedRoles: [UserRole.Client, UserRole.Freelancer],
      confidenceThreshold: 0.55,
      supportedAgents: ['AG-404'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.MARKETING_EMAIL,
      name: 'Email Marketing',
      description: 'Draft lifecycle/campaign emails; sends are gated and opt-outs honoured.',
      category: IntentCategory.Marketing,
      priority: IntentPriority.Low,
      allowedRoles: [UserRole.Client, UserRole.Freelancer],
      confidenceThreshold: 0.55,
      supportedAgents: ['AG-405'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.MARKETING_CAMPAIGN,
      name: 'Marketing Campaign',
      description:
        'Draft a campaign content brief in parallel (research, social and email content).',
      category: IntentCategory.Marketing,
      priority: IntentPriority.Low,
      allowedRoles: [UserRole.Client, UserRole.Freelancer],
      confidenceThreshold: 0.55,
      supportedAgents: ['AG-401', 'AG-402', 'AG-405'],
      status: IntentStatus.Active,
    },
    {
    ...
    {
      id: IntentId.ADMIN_ANALYTICS,
      name: 'Admin Analytics',
      description: 'Answer deterministic platform analytics questions (PRD F21).',
      category: IntentCategory.Admin,
      priority: IntentPriority.High,
      allowedRoles: [UserRole.Admin],
      confidenceThreshold: 0.6,
    ...
    {
      id: IntentId.ADMIN_FRAUD,
      name: 'Admin Fraud Monitoring',
      description: 'Triage fraud/trust signals deterministically, never auto-bans.',
      category: IntentCategory.Admin,
      priority: IntentPriority.High,
      allowedRoles: [UserRole.Admin],
      confidenceThreshold: 0.6,
      supportedAgents: ['AG-502'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.ADMIN_HEALTH,
      name: 'Admin Platform Health',
      description: 'Report platform health metrics and service incidents.',
      category: IntentCategory.Admin,
      priority: IntentPriority.High,
      allowedRoles: [UserRole.Admin],
      confidenceThreshold: 0.6,
      supportedAgents: ['AG-503'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.ADMIN_AI_OPS,
      name: 'Admin AI Operations',
      description: 'Feature-flagged, reversible AI-management change proposals (BR-ADM-4).',
      category: IntentCategory.Admin,
      priority: IntentPriority.High,
      allowedRoles: [UserRole.Admin],
      confidenceThreshold: 0.6,
      supportedAgents: ['AG-504'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.ADMIN_EXECUTIVE,
      name: 'Admin Executive Insights',
      description: 'Aggregated executive review from analytics, health and fraud teams.',
      category: IntentCategory.Admin,
      priority: IntentPriority.High,
      allowedRoles: [UserRole.Admin],
      confidenceThreshold: 0.6,
      supportedAgents: ['AG-501', 'AG-502', 'AG-503', 'AG-505'],
      status: IntentStatus.Active,
    },
    {
      id: IntentId.SYSTEM,
