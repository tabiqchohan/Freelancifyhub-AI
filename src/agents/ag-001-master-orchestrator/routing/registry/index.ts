...
const INTENT_CAPABILITIES: Readonly<Record<IntentId, readonly string[]>> = {
  ...
  [IntentId.MARKETING_RESEARCH]: ['marketing.research'],
  [IntentId.MARKETING_SOCIAL]: ['marketing.post.draft'],
  [IntentId.MARKETING_BLOG]: ['marketing.blog.draft'],
  [IntentId.MARKETING_SEO]: ['marketing.seo.analyze'],
  [IntentId.MARKETING_EMAIL]: ['marketing.email.draft'],
  [IntentId.MARKETING_CAMPAIGN]: [
    'marketing.research',
