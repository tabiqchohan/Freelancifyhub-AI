/**
 * Sprint 21 — Client AI Team v1. Deterministic metrics (§26).
 *
 * Lightweight counters/gauges for the client-AI service. All numbers are
 * locally aggregated; nothing sensitive is ever stored.
 */

/** Counter snapshot for the client-AI team. */
export interface ClientAICounters {
...
/** Gauge snapshot for the client-AI team. */
export interface ClientAIGauges {
...
export interface ClientAIMetricsSnapshot {
  readonly counters: ClientAICounters;
  readonly gauges: ClientAIGauges;
  readonly averageLatencyMs: number;
}

/** Deterministic metrics for the client-AI service. */
export class ClientAIMetrics {
  readonly name = 'client-ai-metrics';
  ...
  snapshot(): ClientAIMetricsSnapshot {
